...
//var auth = getcookieAuth("AMS_SESSION_ID");//cookie
var authorization = getcookie("Authorization");//auth
var login_type = getcookie("LOGINTYPE");//login_type
var locationHref =  window.location.protocol+"//"+window.location.host;
var liveCount = getcookie("LIVECOUNT");

function Init_license(login_auth)
{
  /*  if(login_auth != null)
    {*/
        $.ajax({
            ...
            success: function(data)
            {
                ...
                if(obj != null)
                {
                    ...
                    if(valid == false)
                    {
                        top.location.href='/lic_admin.html';
                    }
                }
            },
            error:function(data)
